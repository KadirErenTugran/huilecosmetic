...
console.log(product);
    return(
        <>
        <Link className='btn btn-dark my-3' to={'/'}> <FaArrowLeft className='text-success'/> <strong>Go Back</strong> </Link>
        <Row >
            <Col md={5}>
                        ...
                        <ListGroupItem>
                            <Row >
                                <Col > <strong>Stock: </strong> </Col>
                                  <Col >  <strong> {product.countInStock >0? `Stokta Var: ${product.countInStock}`:'Stokta Yok'} </strong>  </Col>  
                            </Row>
                        </ListGroupItem>
                            <ListGroupItem>
                                <Button 
